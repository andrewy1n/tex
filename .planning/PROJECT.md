...
- [ ] `.tex` sources (and related assets like `.bib`, figures, and class/style files) live in-repo with a layout that is easy to navigate
- [ ] You can open and edit any `.tex` file in Cursor/VS Code without leaving the repo
- [ ] Coding agents can read and modify project files as normal workspace files
- [ ] Light, repeatable local build (script, `latexmk`, Makefile, and/or editor tasks); no requirement for CI in v1
...
|----------|-----------|---------|
| Source-first repo plus light build hooks | Matches “like Overleaf” as project storage while staying in the IDE | — Pending |
