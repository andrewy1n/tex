...
- [x] **Phase 6: Linting & formatting** — `chktex` linting and `latexindent` formatting with docs and optional auto-run
- [x] **Phase 7: Revision tracking** — `latexdiff` workflow with Make integration and documentation
...
|-------|----------------|--------|-----------|
| 6. Linting & formatting | 1/1 | Complete | 2026-03-27 |
| 7. Revision tracking | 1/1 | Complete | 2026-03-27 |

---

**Generated:** 2026-03-27  
**Milestone:** v1.2 — Quality tooling & templates  
**Coverage:** 7/7 requirements mapped and shipped
